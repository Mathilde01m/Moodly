  ...
  return (
    ...
    >
      ...
      <TouchableOpacity style={styles.profileIcon}>
        <Image 
          source={require('../assets/images/profile.png')}  // Remplace par l'icône de profil
      ...
      <View style={styles.inputContainer}>
        ...
        <TouchableOpacity style={styles.sendButton} onPress={sendMessage}>
          <Image 
            source={require('../assets/images/profile.png')}  // Icône d'envoi (assurez-vous que le fichier existe)
