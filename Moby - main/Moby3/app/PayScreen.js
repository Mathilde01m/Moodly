  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.profileIcon}>
        <Image
          source={require('../assets/images/profile.png')}  // Remplacer par ton icône de profil
      ...
      <View style={styles.leftPanel}>
        ...
        <MenuItem icon={require('../assets/images/home.png')} label="Tableau de bord" onPress={() => alert('Tableau de bord')} />
        <MenuItem icon={require('../assets/images/profile.png')} label="Bulletins de paie" onPress={() => alert('Bulletins de paie')} />

        {/* Section Au quotidien */}
        <Text style={styles.sectionTitle}>Au quotidien</Text>
        <MenuItem icon={require('../assets/images/profile.png')} label="Absences" onPress={() => alert('Absences')} />
        <MenuItem icon={require('../assets/images/home.png')} label="Entretiens et objectifs" onPress={() => alert('Entretiens et objectifs')} />
